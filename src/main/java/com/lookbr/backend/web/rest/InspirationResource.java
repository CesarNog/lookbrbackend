...
public class InspirationResource {
    ...
    /**
     * SEARCH  /_search/inspirations?query=:query : search for the inspiration corresponding
     * to the query.
     *
     * @param query the query of the inspiration search
     * @return the result of the search
     */
    @GetMapping("/_search/inspirations")
    @Timed
    public List<InspirationDTO> searchInspirations(@RequestParam String query) {
        log.debug("REST request to search Inspirations for query {}", query);
        return inspirationService.search(query);
    }

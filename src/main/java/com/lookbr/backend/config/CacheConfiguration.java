...
public class CacheConfiguration {
    ...
    public JCacheManagerCustomizer cacheManagerCustomizer() {
        return cm -> {
            ...
            cm.createCache(com.lookbr.backend.domain.PersistentToken.class.getName(), jcacheConfiguration);
            cm.createCache(com.lookbr.backend.domain.User.class.getName() + ".persistentTokens", jcacheConfiguration);

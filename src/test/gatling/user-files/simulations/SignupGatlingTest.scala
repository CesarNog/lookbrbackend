...
/**
 * Performance test for the Signup entity.
 */
class SignupGatlingTest extends Simulation {
    ...
    val scn = scenario("Test the Signup entity")
        ...
        .repeat(2) {
            ...
            .pause(10)
            .repeat(5) {
                exec(http("Get created signup")
                .get("${new_signup_url}")
                .headers(headers_http_authenticated))
                .pause(10)
            }
            .exec(http("Delete created signup")
            .delete("${new_signup_url}")
            .headers(headers_http_authenticated))
            .pause(10)
        }

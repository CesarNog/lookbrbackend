...
/**
 * Performance test for the Look entity.
 */
class LookGatlingTest extends Simulation {
    ...
    val scn = scenario("Test the Look entity")
        ...
        .repeat(2) {
            ...
            .pause(10)
            .repeat(5) {
                exec(http("Get created look")
                .get("${new_look_url}")
                .headers(headers_http_authenticated))
                .pause(10)
            }
            .exec(http("Delete created look")
            .delete("${new_look_url}")
            .headers(headers_http_authenticated))
            .pause(10)
        }
